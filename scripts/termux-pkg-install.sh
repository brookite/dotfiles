...
pkg install python-psutil python-numpy python-pillow python-pandas python-lxml python-scipy python-yt-dlp matplotlib ruff uv leveldb libusb mandoc lazygit jq -y
