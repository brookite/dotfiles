...
pkg install python-psutil python-numpy python-pillow python-pandas python-lxml python-scipy python-yt-dlp matplotlib ruff uv ty leveldb libusb mandoc lazygit poppler jq -y
